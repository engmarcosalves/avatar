...
public class UnityOfWorkProfilePhotoRepository implements ProfilePhotoRepository {
    ...
    public UnityOfWorkProfilePhotoRepository(HibernateProfilePhotoPersistenceRepository persistenceRepository,  S3ProfilePhotoStorageRepository storageRepository) {
